...
Cataluna_NO2_vals = Cataluna_NO2(Cataluna_NO2 > 128);
Andalucia_NO2_vals = Andalucia_NO2(Andalucia_NO2 > 128);
Madrid_NO2_vals = Madrid_NO2(Madrid_NO2 > 128);

% Calcular medias

Cataluna_stats = mean(Cataluna_NO2_vals);
Andalucia_stats = mean(Andalucia_NO2_vals);
Madrid_stats = mean(Madrid_NO2_vals);

% Mostrar estadísticas
disp('Cataluña: Media');
disp(Cataluna_stats);
disp('Andalucía: Media');
